 ...
 * num_bits indica cuantos bits con los que queremos operar. 
 */
 ...
 *		- valor que retorna la funcion: 10 (lee los 4 bits 12-15)
 */
...
/**
 * El gpio se configuran como entrada o salida segun la direccion.
 */
void hal_gpio_sentido(HAL_GPIO_PIN_T gpio, hal_gpio_pin_dir_t direccion);
 
/**
 * La funcion devuelve un entero (bool), sera cero si el gpio es cero, sera distinto de cero en caso contrario.
 */
