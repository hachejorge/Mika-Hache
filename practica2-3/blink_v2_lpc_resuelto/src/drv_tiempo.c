...
static volatile uint32_t ID_LED_CONMUTAR;	// ID del led que va a conmutarse en la función callback en un periodo de ms

void f_callback_driver(){
		f_callback(ID_LED_CONMUTAR, drv_tiempo_actual_ms());
}
